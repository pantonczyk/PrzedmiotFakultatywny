export const initialState = {
   articles: [
      ...
      },
      {
         ...
         imageLink:
            'https://sekurak.pl/wp-content/uploads/2020/12/AdobeStock_245125119-150x150.jpeg',
      },
      {
         id: 4,
         type: 'articles',
   ...
   songs: [
      {
         ...
         autor: 'Luis Fonsi',
         link:
            'https://www.youtube.com/watch?v=kJQP7kiw5Fk&list=PLirAqAtl_h2pRAtj2DgTa3uWIZ3-0LKTA',
         imageLink:
      ...
      },
      {
         ...
         autor: 'Maroon 5',
         link:
            'https://www.youtube.com/watch?v=09R8_2nJtjg&list=PLirAqAtl_h2pRAtj2DgTa3uWIZ3-0LKTA&index=3',
         imageLink:
      ...
      },
      {
         ...
         autor: 'OneRepublic ',
         link:
            'https://www.youtube.com/watch?v=hT_nvWreIhg&list=PLirAqAtl_h2pRAtj2DgTa3uWIZ3-0LKTA&index=6',
         imageLink:
      ...
      },
      {
         ...
         autor: 'Adele',
         link:
            'https://www.youtube.com/watch?v=YQHsXMglC9A&list=PLirAqAtl_h2pRAtj2DgTa3uWIZ3-0LKTA&index=11',
         imageLink:
      ...
      },
      {
         ...
         autor: 'Avicii',
         link:
            'https://www.youtube.com/watch?v=IcrbM1l_BoI&list=PLirAqAtl_h2pRAtj2DgTa3uWIZ3-0LKTA&index=27',
         imageLink:
